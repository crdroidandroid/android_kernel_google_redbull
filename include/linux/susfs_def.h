...
#define BIT_SUS_PATH (1UL << AS_FLAGS_SUS_PATH)
#define BIT_SUS_MOUNT (1UL << AS_FLAGS_SUS_MOUNT)
#define BIT_SUS_KSTAT (1UL << AS_FLAGS_SUS_KSTAT)
#define BIT_OPEN_REDIRECT (1UL << AS_FLAGS_OPEN_REDIRECT)
#define BIT_SUS_MAPS (1UL << AS_FLAGS_SUS_MAP)
